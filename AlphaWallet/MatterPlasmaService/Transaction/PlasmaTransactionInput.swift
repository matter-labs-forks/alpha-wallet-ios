...
public struct PlasmaTransactionInput {
...
extension PlasmaTransactionInput: Equatable {
    public static func ==(lhs: PlasmaTransactionInput, rhs: PlasmaTransactionInput) -> Bool {
